...
public class WordCount {
    ...
    /* 输入：file，文件名列表，每行一个文件名,文件名不能含空格
     * 输出：<file1 file2, count percentage> 输出的空格严格按照这种格式
     * file1和file2对比，count是file1中重合处数目，percentage是重合字数占file1总字数百分比
     */
    public static class TokenizerMapper
        ...
        public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
            try {
                ...
                while(itr.hasMoreTokens()){
                    //sa[j]=itr.nextToken();
					//j++;
                	fileNameList.add(itr.nextToken());
                }
                //NOTIC:change this to suit for your hadoop configure
                String file_uri="hdfs://master:9000/user/calm/";
                for(int i=0;i<fileNameList.size()-1;i++){
                    file1_origin=fileNameList.get(i);
                    file1=file_uri+file1_origin;
                    String text1 = "";
                    text1 = readFile(file1);
                    //System.out.println(text1);
                    for (int k=i+1;k<fileNameList.size();k++) {
                        diff_match_patch dmp = new diff_match_patch();
                        String text2 = "";
                        file2_origin=fileNameList.get(k);
					    file2=file_uri+file2_origin;
                        text2 = readFile(file2);
                        //System.out.println(text2);
                        dmp.text1_length = text1.length();
                        dmp.text2_length = text2.length();
                        LinkedList<Diff> d = dmp.diff_main(text1, text2);
                        dmp.diff_cleanupSemantic(d);
                        int diff_rate = dmp.diff_uglyHtml(d);
                        IntWritable one = new IntWritable(diff_rate);
                        //写入<file1 file2, count percentage>
                        String result = file1_origin+ "_" +file2_origin;
                        word.set(result);
                        context.write(word, one);
                        String ii = String.valueOf(diff_rate);
        ...
        public String readFile(String filename){
            //put your attention on this varable:uri
    ...
    */
    ...
    public static class diff_match_patch {
        ...
        public int text1_length = 0;
        public int text2_length = 0;

        /*输入路径，读取文件，输出string，无过滤标点*/
        ...
        public void write_file(String content) {
            try {
        ...
        /**
         * Internal class for returning results from diff_linesToChars(). Other
         * less paranoid languages just use a three-element array.
         */
         ...
         * optimal diff. This method allows the 'checklines' of diff_main() to
         * be optional. Most of the time checklines is wanted, so default to
         * true.
         *
         ...
         * return the recursively constructed diff. See Myers 1986 paper: An
         ...
         * @return Five element String array, containing the prefix of longtext,
         ...
         * can be shifted sideways to align the edit to a word boundary. e.g:
        ...
        public int diff_uglyHtml(LinkedList<Diff> diffs) {
            StringBuilder html = new StringBuilder();
            int count = 0;
            int wordcount = 0;
            for (Diff aDiff : diffs) {
            ...
            float per = wordcount / (float) this.text1_length * 100;
            DecimalFormat dcmFmt = new DecimalFormat("0.00");
            //html.append(String.valueOf(count)+" "+ String.valueOf(dcmFmt.format(per)));
            return (int) per;
        }
        ...
        //  MATCH FUNCTIONS
        /**
         * Locate the best instance of 'pattern' in 'text' near 'loc'. Returns
         * -1 if no match found.
         *
        ...
        /**
         * Compute a list of patches to turn text1 into text2. A set of diffs
         * will be computed.
         *
        ...
        /**
         * Compute a list of patches to turn text1 into text2. text1 will be
         * derived from the provided diffs.
         *
         ...
         * as an array of true/false values indicating which patches were
         * applied.
         *
         * @param patches Array of Patch objects
         * @param text Old text.
         ...
         * encodeURI. In speed critical applications this could be dropped since
         * the receiving application will certainly decode these fine. Note that
         * this function is case-sensitive. Thus "%3f" would not be unescaped.
         * But this is ok because it is only called with the output of
